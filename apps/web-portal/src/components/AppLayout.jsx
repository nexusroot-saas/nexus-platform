...
const Icon = {
  Dashboard: () => (
    <svg className="nav-item-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  Shield: () => (
    <svg className="nav-item-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M10 2L4 5v5c0 3.5 2.5 6.74 6 7.5C14.5 16.74 17 13.5 17 10V5l-7-3z"/>
    </svg>
  ),
  FileText: () => (
    <svg className="nav-item-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  Logout: () => (
    <svg className="nav-item-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M13 15l3-3-3-3M16 12H7M7 3H4a1 1 0 00-1 1v12a1 1 0 001 1h3"/>
    </svg>
  ),
};

// ── Semântica por tenant_type ─────────────────────────────────────────
const LABELS = {
        ...
        <div className="sidebar-logo">
          <div className="sidebar-logo-mark">
            ...
            <div>
              ...
              <div className="sidebar-logo-sub">Plataforma Nexus</div>
            </div>
          </div>
        </div>
